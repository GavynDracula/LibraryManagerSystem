...
#include "ui_adminbookdetaildialog.h"

AdminBookDetailDialog::AdminBookDetailDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AdminBookDetailDialog)
{
    ui->setupUi(this);
    this->setWindowTitle("Book's detail information");
    model = new QSqlQueryModel;
}

AdminBookDetailDialog::~AdminBookDetailDialog()
{
    delete ui;
}

void AdminBookDetailDialog::SetDisplay(QSqlDatabase *db, QString isbn)
{
    QSqlQuery query(*db);
